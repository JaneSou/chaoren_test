...
def check_network_connection(server="www.baidu.com"):
    """
    Checks if chaoren can connect a network server.
...
def run():
    ...
    logger.info("Starting chaoren diagnostic at %s" % time.strftime("%c"))
    ...
    for fname in [os.path.join(chaorenpath.APP_PATH, os.pardir,
                               "phonetisaurus",
                               "g014b2b.fst")]:
